...
let ChatGateway = class ChatGateway {
    ...
    handleJoinMission(client, missionId) {
        void client.join(`mission:${missionId}`);
    }
    async handleSendMessage(client, payload) {
        const result = await this.chatService.sendMessage(payload.missionId, payload.senderId, payload.content, payload.isPreset ?? false);
        if (!result.isFlagged) {
            this.server
...
], ChatGateway.prototype, "handleJoinMission", null);
__decorate([
