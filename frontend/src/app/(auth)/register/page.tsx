...
import { Mail, Lock, User, ShoppingBag, Building2 } from 'lucide-react';
    ...
    <div className="bg-card border border-border rounded-xl shadow-modal p-8">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-foreground-secondary text-sm mt-1">
          Rejoignez la marketplace du live selling
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <div className={cn(
              ...
              role === 'client' ? 'bg-primary' : 'bg-muted',
            )}>
              <User className={cn('h-4 w-4', role === 'client' ? 'text-white' : 'text-foreground-secondary')} />
            </div>
            <div>
          ...
          >
            <div className={cn(
              'flex h-8 w-8 items-center justify-center rounded-lg shrink-0 mt-0.5',
              role === 'vendeur' ? 'bg-primary' : 'bg-muted',
            )}>
              <ShoppingBag className={cn('h-4 w-4', role === 'vendeur' ? 'text-white' : 'text-foreground-secondary')} />
            </div>
            <div>
        ...
        {role === 'client' && (
          <>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-foreground-secondary" />
                <Input
                  id="companyName"
                  className="pl-9 bg-muted border-border text-foreground"
