...
export default function ModerateurDashboardPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold">Dashboard modération</h1>
      <p className="text-muted-foreground text-sm">
        {messages.length} message(s) signalé(s) en attente de traitement.
      </p>
              ...
              <CardHeader className="py-3 px-4">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm mt-1 break-all">{msg.content}</p>
                  </div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Mission : {msg.missionId.slice(0, 8)}
                </p>
              </CardHeader>
